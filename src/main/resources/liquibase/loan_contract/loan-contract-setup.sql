...
VALUES
    ...
    ('Laenuandja annab Laenusaajale laenu ${loan.amount} ${loan.currency} (edaspidi Laen).'),
    ...
    ('Laenusaaja maksab Laenuandjale Laenu tagastamata osalt intressi ${loan.interest}% aastas.'),
