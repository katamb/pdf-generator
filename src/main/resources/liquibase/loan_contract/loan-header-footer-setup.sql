...
VALUES
    ...
    ('PRIVATE_SMALL_LOAN_CONTRACT_EE', 'et', 'HEADER_TEXT_1', 10.0, 0, 'HEADER',
        (SELECT text_block_id from text_block where text_block_value='Laenuleping ${loan.contractNumber}')
    )
;